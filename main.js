document.addEventListener("DOMContentLoaded", () => {
    ...
    function createEventCard(evt, animDelayIndex) {
        ...
        const actionButtons = evt.status === 'upcoming' 
            ? `<button class="btn btn-primary" data-action="resources" data-event-id="${evt.id}">
                    <i class='bx bx-file'></i> Resources
               </button>
            ...
            : `<button class="btn btn-secondary" data-action="calendar" data-event-id="${evt.id}">
               ...
               <button class="btn btn-secondary" data-action="resources" data-event-id="${evt.id}">
                    <i class='bx bx-file'></i> Resources
               </button>`;
